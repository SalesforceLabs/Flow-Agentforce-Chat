...
export default class FlowAgentforceAgentChat extends LightningElement {
    // IMPORTANT: Use the API Name of your Agentforce Agent (e.g., 'Service_Agent').
    // You can find this in Setup > Agents.
    @api agentId; 
    ...
    startNewSession() {
        this.isLoading = true;
        // Add an immediate joining indicator using the typing state
        this.chatHistory = [{
            key: 'joining-indicator',
        ...
        startSession({ agentId: this.agentId })
            .then(result => {
                // Remove joining indicator
                this.chatHistory = this.chatHistory.filter(msg => msg.key !== 'joining-indicator');
